...
- Form validation is a way to validate the from's data on the clients computer before sending it to the web server. It can check for maditory fields to be filled in.

1. In 1-2 sentences, define end to end testing.

- end to end testing is an approach in which we test a fully working app. We can test if the app is behaving corectly from beginning to finish.
